...
void cc2500_init(void)
{
  ...
  write_reg(CC2500_REG_FREQ2, 0x20);
  write_reg(CC2500_REG_FREQ1, 0x25);
  write_reg(CC2500_REG_FREQ0, 0xED);
  
  // value from SmartRF
  write_reg(CC2500_REG_DEVIATN, 0x0);
}
